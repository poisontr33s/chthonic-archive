...
- Generated: `2026-03-07T03:25:22Z`
- Session: `2026-03-07T03-25-22Z_claudine_trilemma`
- Dry run: `True`
- Copy sources: `False`
- Existing sources: `10` / `10`
...
- `Kali` -> preferred `Kali Nyx Ravenscar`
  status: preferred_old_name
  drift variants: Kali Praharshini
...
- `Vesper` -> preferred `Vesper Mnemosyne Lockhart`
  status: preferred_old_name
  drift variants: Vesper Tempus
...
- `Seraphine` -> preferred `Seraphine Ashveil`
  status: preferred_old_name
  drift variants: Seraphine Pyralis
...
- `Spectra` -> preferred `Spectra Chroma Excavatus`
  secondary epithet: `The Prismatic Caretaker`
  status: full_name_required
  drift variants: Spectra Chroma
...
- `Snow White line` -> preferred `Alabaster Voyde`
  secondary epithet: `The Coke-Fuelled Snow White`
  status: canonical_but_shorthand_sensitive
  drift variants: Snow White
...
- `QMR anomaly bride` -> preferred `Novia Cadaveris`
  secondary epithet: `The Necromancy-Pale Bridesmaiden`
  status: must_be_present
  drift variants: The White-Dressed Bride, The Corpse-Reviver
