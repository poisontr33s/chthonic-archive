...
# Block 1: 5555 to 7405 (1-based)
# Python is 0-based. so index 5554 to 7404 inclusive.
block1_start = 5554
block1_end = 7404
...
for i, line in enumerate(lines):
    ...
    if i == block2_start:
        ...
        break # We stop after adding the second offload because it's the tail
        
    if i > block1_end and i < block2_start:
        new_lines.append(line)

with open(file_path, 'w', encoding='utf-8') as f:
    f.writelines(new_lines)

print("SSOT Stripping Complete.")
