# Overnight Daemon Report (20260219_030002)

- Repo root: C:/Users/erdno/chthonic-archive
- Files scanned: 1361
- TODO/FIXME/HACK hits (captured): 95
...
| 15 | extensions/chthonic-archive/native/chthonic-daemon/src/entropy_monitor.rs | 485 | 0 | Moderate Complexity, Documentation Debt: 355 (rel to complexity: 71, density: 0.00), rust code |
| 16 | scripts/harvest_claudines.ps1 | 468 | 0 | Moderate Complexity, Documentation Debt: 310 (rel to complexity: 82, density: 0.12), repo tooling, powershell tooling |
| 17 | scripts/rustification_trend_tracker.py | 466 | 0 | Moderate Complexity, Documentation Debt: 326 (rel to complexity: 66, density: 0.01), repo tooling |
| 18 | extensions/chthonic-archive/scripts/verify-host.ts | 459 | 0 | Moderate Complexity, Documentation Debt: 349 (rel to complexity: 70, density: 0.00) |
| 19 | mas_mcp/test_hardware_specific.py | 458 | 0 | Moderate Complexity, Documentation Debt: 348 (rel to complexity: 78, density: 0.05) |
| 20 | scripts/hf_refiner.py | 456 | 0 | Moderate Complexity, Documentation Debt: 316 (rel to complexity: 68, density: 0.03), repo tooling |
