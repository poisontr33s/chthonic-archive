...
/**
 * MCP Legacy Server — Observatory communication layer (deprecated)
 *
 * @SID           TOOL_MCP_LEGACY_SERVER_V1
 * @Shabti        CLI Script (deprecated)
 * @Heka-Ayni     CONCEPT_MCP_STDIO_DISPATCH
 * @Ankh-Tinku    STATE_MCP_LEGACY_DEPRECATED
 * @Purpose       Original MCP server implementation using stdio transport.
 *                Dispatches to scanRepository, validateSSOT,
 *                queryDependencyGraph, and preflightExecutionContext tools.
 */
