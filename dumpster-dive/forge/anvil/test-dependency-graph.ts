// @SID: FORGE_TEST_DEPENDENCY_GRAPH_V1
// ╔════════════════════════════════════════════════════════════════════════════
...
/**
 * Test suite for query_dependency_graph tool (deprecated)
 *
 * @SID           TEST_MCP_DEPENDENCY_GRAPH_V1
 * @Shabti        Test Script (deprecated)
 * @Purpose       Validates dependency graph queries: stats, spectral filter,
 *                node lookup, dependency/dependent traversal.
 */
