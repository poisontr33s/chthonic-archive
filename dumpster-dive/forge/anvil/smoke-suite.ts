...
// ║   └─◄ mcp/tools/queryDependencyGraph.ts
// ║   └─◄ mcp/tools/scanRepository.ts
// ║   └─◄ mcp/tools/validateSSOT.ts
// ╚════════════════════════════════════════════════════════════════════════════

/**
 * MCP Smoke Test Suite (deprecated)
 *
 * @SID           TEST_MCP_SMOKE_SUITE_V1
 * @Shabti        Test Script (deprecated)
 * @Heka-Ayni     CONCEPT_MCP_WORKFLOW_VALIDATION
 * @Ankh-Tinku    STATE_MCP_SMOKE_DEPRECATED
 * @Purpose       Executes all 6 canonical workflows from
 *                docs/MCP_USER_WORKFLOWS.md. Saves structured results
 *                per minimal reporting format to artifacts/.
 */
