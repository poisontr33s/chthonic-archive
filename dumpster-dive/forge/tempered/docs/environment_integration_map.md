...
created: 2026-03-04T19:10:41+00:00
...
- `CHTHONIC_LLM_BASE_URL` | type `string` | secret `False` | sources: claude-codex-gemini/session_resumption_pickup/UNCENSORED_LANE_RUNTIME_20260219_231721.env, claude-codex-gemini/session_resumption_pickup/UNCENSORED_LANE_RUNTIME_LATEST.env
- `CHTHONIC_LLM_CODE_MODEL_PATH` | type `string` | secret `False` | sources: claude-codex-gemini/session_resumption_pickup/UNCENSORED_LANE_RUNTIME_20260219_231721.env, claude-codex-gemini/session_resumption_pickup/UNCENSORED_LANE_RUNTIME_LATEST.env
- `CHTHONIC_LLM_DEFAULT_LANE` | type `string` | secret `False` | sources: claude-codex-gemini/session_resumption_pickup/UNCENSORED_LANE_RUNTIME_20260219_231721.env, claude-codex-gemini/session_resumption_pickup/UNCENSORED_LANE_RUNTIME_LATEST.env
- `CHTHONIC_LLM_DEFAULT_MODEL_PATH` | type `string` | secret `False` | sources: claude-codex-gemini/session_resumption_pickup/UNCENSORED_LANE_RUNTIME_20260219_231721.env, claude-codex-gemini/session_resumption_pickup/UNCENSORED_LANE_RUNTIME_LATEST.env
- `CHTHONIC_LLM_STRICT_JSON_MODEL_PATH` | type `string` | secret `False` | sources: claude-codex-gemini/session_resumption_pickup/UNCENSORED_LANE_RUNTIME_20260219_231721.env, claude-codex-gemini/session_resumption_pickup/UNCENSORED_LANE_RUNTIME_LATEST.env
- `CHTHONIC_LLM_UNRESTRICTED_MODEL_PATH` | type `string` | secret `False` | sources: claude-codex-gemini/session_resumption_pickup/UNCENSORED_LANE_RUNTIME_20260219_231721.env, claude-codex-gemini/session_resumption_pickup/UNCENSORED_LANE_RUNTIME_LATEST.env
...
- `ENTITY_REGISTRY_PATH` | type `string` | secret `False` | sources: mas_mcp/frontend/.env
...
- `GENESIS_ARTIFACTS_DIR` | type `string` | secret `False` | sources: mas_mcp/frontend/.env
- `GENESIS_GPU_PROVIDER` | type `string` | secret `False` | sources: mas_mcp/frontend/.env
- `GENESIS_LOGS_DIR` | type `string` | secret `False` | sources: mas_mcp/frontend/.env
- `GROQ_API_KEY` | type `string` | secret `True` | sources: codex/mailbox/API_KEY_ENV_TEMPLATE_20260226T045112Z.env
- `HOST` | type `string` | secret `False` | sources: mas_mcp/frontend/.env
...
- `PORT` | type `integer` | secret `False` | sources: mas_mcp/frontend/.env
...
- `SLO_ACCEPTANCE_RATE` | type `string` | secret `False` | sources: mas_mcp/frontend/.env
- `SLO_P50_LATENCY_MS` | type `integer` | secret `False` | sources: mas_mcp/frontend/.env
- `SLO_P95_LATENCY_MS` | type `integer` | secret `False` | sources: mas_mcp/frontend/.env
- `SLO_VRAM_PCT` | type `integer` | secret `False` | sources: mas_mcp/frontend/.env
