...
- Source: [`.github/workflows/claude-code-review.yml.off`](../../../../.github/workflows/claude-code-review.yml.off)
- Jobs: pull_request, claude-review
- Actions: actions/checkout@v4, anthropics/claude-code-action@v1

## Claude Code

- Source: [`.github/workflows/claude.yml.off`](../../../../.github/workflows/claude.yml.off)
- Jobs: issue_comment, issues, claude
- Actions: actions/checkout@v4, anthropics/claude-code-action@v1

## '🔀 Gemini Dispatch'

- Source: [`.github/workflows/gemini-dispatch.yml.off`](../../../../.github/workflows/gemini-dispatch.yml.off)
...
- Source: [`.github/workflows/gemini-invoke.yml.off`](../../../../.github/workflows/gemini-invoke.yml.off)
...
- Source: [`.github/workflows/gemini-review.yml.off`](../../../../.github/workflows/gemini-review.yml.off)
...
- Source: [`.github/workflows/gemini-scheduled-triage.yml.off`](../../../../.github/workflows/gemini-scheduled-triage.yml.off)
...
- Source: [`.github/workflows/gemini-triage.yml.off`](../../../../.github/workflows/gemini-triage.yml.off)
