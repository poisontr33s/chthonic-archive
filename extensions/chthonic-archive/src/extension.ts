...
export function activate(context: vscode.ExtensionContext) {
    ...
    const allowNativeSidecars = chthonicConfig.get<boolean>('security.allowNativeSidecars', false);
    ...
    if (workspaceRoot && entropyEnabled) {
        ...
        if (entropyPolyglotEnabled && allowNativeSidecars) {
    ...
    if (reactorReadiness.ready && workspaceRoot && reactorEnabled && allowNativeSidecars) {
    ...
    if (workspaceRoot && slabSelfHealingEnabled && allowNativeSidecars) {
