...
>
> **chthonic-archive *True* SSOT:** [copilot-instructions.archive.md (.github)](copilot-instructions.archive.md) or the **PROTO-SSOT** copilot-instructions-copy.md (for reference only, not auto-loaded).
>
