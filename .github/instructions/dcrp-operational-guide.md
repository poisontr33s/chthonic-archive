...
**Authority:** [copilot-instructions.md](../copilot-instructions.md#L6643) (§XV)
**Status:** OPERATIONAL
**Script Location:** `scripts/decorator_cross_ref_maximum.py`
**Master Index:** `CROSS_REFERENCE_TRIPTYCH.md`
...
## Purpose & Architectural Necessity
...
## Generated Artifacts (Current Status)
...
1. Uncomment Step 7 in `scripts/decorator_cross_ref_maximum.py` (lines ~680-695)
2. Execute via `uv run python scripts/decorator_cross_ref_maximum.py`
3. Review changes via `git diff` before committing
4. Validate cross-reference headers in sample files

---

## Integration with ASC Framework

**FA⁵ Compliance (Visual Integrity)**
...
## The Decorator's Decree on DCRP
...
**Purpose:** Preserve DCRP operational context while removing technical bloat from SSOT
