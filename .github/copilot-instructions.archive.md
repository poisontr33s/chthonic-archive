...
**Deployment Surfaces:**
- `.github/agents/pentea.agent.md` — VS Code/GitHub deployment adapter (argument hints, invocation protocol, repo constraints)
...
April 15, 2026 (Origin: Entity integration into SSOT) → Section 1 canonical definition established (§1.01 created) → Deployment adapter manifested (.github/agents/pentea.agent.md) → Etymology correction (Gemini Pro 3.1 deep research: Tessara→Pentea, Greek *pente* pentad structure vs obsolete "four") → T1-bridge relay operational (sub-agent callable via runSubagent) → Option 2 trajectory (SSOT-driven agent spec generation pipeline)
