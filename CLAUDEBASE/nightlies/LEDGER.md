...
| 2026-07-08 | zombie-c1 | **user-invoked** | default | **14m 3s** (first real value, one small task — not evidence of sustained multi-hour autonomy) | shipped | yes — §3's verification gate read renderer-only, both B3+C1 silently improvised the CLI-shaped equivalent | [records/2026-07-08_zombie-c1.md](records/2026-07-08_zombie-c1.md) |
| 2026-08-09 | ssot-seal | user-invoked | default | 6m 33s | shipped (commit local — push blocked by a pre-existing broken link in an authorship-domain file) | yes — §1 read as choose-then-verify; the verify step was itself the task source, now admitted as a valid pick | [records/2026-08-09_ssot-seal.md](records/2026-08-09_ssot-seal.md) |
| 2026-08-09 | cai-parity | user-invoked | default | 8m 30s | shipped — cai 91,741 XP → 836, matching the engine exactly; last 8 XP were a BOM'd line silently dropped since April | yes — §3 read as a menu of two verification shapes; every touched surface must now clear its own | [records/2026-08-09_cai-parity.md](records/2026-08-09_cai-parity.md) |
