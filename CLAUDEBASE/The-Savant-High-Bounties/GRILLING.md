...
This file is not a summary. It is the **evidence base** for every gate and task in [TODO.md](TODO.md).
...
Begin executing from [TODO.md](TODO.md). Return here when a task needs justification or deeper context.
...
| ML pipeline | Python 3.14 / uv / torch 2.11.0+cu128 / CUDA 12.8 | `apps/flux-satellite/`, `mas_mcp/` |
| Intelligence server | Python 3.14 / FastMCP / numpy | `mas_mcp/` |
...
*Feeds: [TODO.md Gate -5](TODO.md#gate--5--governance-integrity-substrate-health)*
...
- **Macro-prompt-world (the world-document):** `.github/copilot-instructions.archive.md` — 10,500+ lines, lifecycle `ssot-canon`, read-only. Also known as the *Codex Brahmanica Perfectus* and the *unabridged SSOT-L-H*. This file was written BEFORE most of the codebase existed. Everything else — the game engine, the CI system, the MCP servers, the agent court — was created as an implementation of what this document describes. The `.archive.md` suffix and `.github/` location are naming artifacts from its origin; the name `copilot-instructions` is legacy and misleading. It is NOT an instruction file. It is the living world-document from which all doctrine descends.
- **RootDIR SSOT pointer:** `.chthonic/SSOT.md` — the live governance descriptor. References the world-document by name. Agents read this at session start. It is the entry point into the world, not the world itself.
...
- **Rule inventory:**
  ...
  - `titlecase_concept` — bare concept names: `the-Savant` and `The-Savant`
...
## SECTION 2 · CI SYSTEM
*Feeds: [TODO.md Gate -4](TODO.md#gate--4--ci-system-integrity-enforcement-health)*
...
## SECTION 3 · TOOLCHAIN
*Feeds: [TODO.md Gate -3](TODO.md#gate--3--toolchain-coherence-runtime-health)*
...
*Feeds: [TODO.md Gate -2](TODO.md#gate--2--architectural-debt-reduction-structure-health)*
...
*Feeds: [TODO.md Gate -1](TODO.md#gate--1--mcp-ecosystem-modernization-intelligence-layer)*
...
*Feeds: [TODO.md Gate -2 T-2.3](TODO.md#t-23--character-schema--full-lore-validation-pass-auto), [Gate +4](TODO.md#gate-4--game-engine--v2-architecture-living-world)*
...
*Feeds: [TODO.md Gate +1](TODO.md#gate-1--solana--gpu-compute-integration-frontier-engineering), [Gate +4](TODO.md#gate-4--game-engine--v2-architecture-living-world)*
...
- **Next gate (G8):** full dungeon cRPG loop — rooms persist cleared state; traversal emits entropy hashes → Solana V10
...
*Feeds: [TODO.md Gate -2 T-2.2](TODO.md#t-22--extension-hallucinatory-ladderization-remediation-decision)*
...
- **View components:** `ActivityBarMorph`, `DesignFrameProvider`, `DeepFocusLayout`, `RestoreOrderLayout`, `LoomViewProvider`, `StylusInputProvider`, `ThemeTreeProvider`, `StatusTreeProvider`
...
*Feeds: [TODO.md Gate +2](TODO.md#gate-2--corpus-intelligence-upgrade-semantic-memory-deepening)*
...
*Feeds: [TODO.md Gate +3](TODO.md#gate-3--agent-court-modernization-intelligence-surface)*
...
*Feeds: [TODO.md Gate 0](TODO.md#gate-0--structural-synthesis-architecture-convergence)*

### Known Isomorphism: todo_roulette ≡ dungeon
...
*Direct feed for [TODO.md Acceptance Criteria](TODO.md#acceptance-criteria--the-1010-run)*
...
*Feeds: [TODO.md Gate 0 T0.4](TODO.md#t04--claudebase-harbor--charts-bootstrap-auto)*

### What It Is
- **Location:** `CLAUDEBASE/` — a clean sub-codebase within the chthonic-archive polyrepo. Not a satellite. Not a junction.
- **SID:** `CLAUDEBASE_ROOT_V1`
- **Commissioned:** 2026-06-05 — all 6 directories empty at commissioning
- **Governance chain:** `CLAUDEBASE/README.md` → `.chthonic/SSOT.md` → world-document
- **Register:** Nautical · Victorian · Renaissance — themed for the T1 matriarch whose operational arm this is
