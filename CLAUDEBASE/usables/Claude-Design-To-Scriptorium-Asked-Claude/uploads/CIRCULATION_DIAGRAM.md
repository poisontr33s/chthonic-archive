...
**See:** [FORGE_CIRCULATION_PROTOCOL.md](../../../../dumpster-dive/protocols/FORGE_CIRCULATION_PROTOCOL.md) for full details
...
- [protocols/FORGE_CIRCULATION_PROTOCOL.md](../../../../dumpster-dive/protocols/FORGE_CIRCULATION_PROTOCOL.md) — Complete protocol specification
- README.md (dumpster-dive) — Overview and context
- [ORE_MANIFEST.json (uploads)](ORE_MANIFEST.json) — Ore rating system (1-5)
- [BLACKSMITH_MATRIARCH.md (dumpster-dive)](BLACKSMITH_MATRIARCH.md) — SFS operator profile

### Dependents (What Needs This Document)
- README.md (dumpster-dive) — Links to this for visual reference
- [protocols/FORGE_CIRCULATION_PROTOCOL.md](../../../../dumpster-dive/protocols/FORGE_CIRCULATION_PROTOCOL.md) — References diagrams
- New users — Quick visual understanding of circulation system

### Related Documentation
- [protocols/FORGE_PROTOCOL_LEVELS.md](../../../../dumpster-dive/protocols/FORGE_PROTOCOL_LEVELS.md) — Complementary 4-level framework
- [DUMPSTER_DIVE_REGISTRY.json](../../../../dumpster-dive/DUMPSTER_DIVE_REGISTRY.json) — Programmatic state tracking
...
**Primary Reference:** [FORGE_CIRCULATION_PROTOCOL.md](../../../../dumpster-dive/protocols/FORGE_CIRCULATION_PROTOCOL.md)  
