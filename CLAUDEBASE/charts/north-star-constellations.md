...
**(`Remaining-Open`)**: Checkerboard/grid CDLOD artifact (new finding, 2026-07-05 — not yet root-caused). Copernicus production promotion (blocked on the checkerboard finding above, not on Copernicus itself). §2.6 astrology half (owner-defined, never invented). Rung 2.5 RT reflections (optional). Site 6 deferred (ELLIPSOID-RETROFIT tags planted).
