...
metadata:
  short-description: "Use when the user asks to generate or edit images via the OpenAI Image API (for example: generate image,..."
---
...
- Use the OpenAI uv run python SDK (`openai` package) for all API calls; do not use raw HTTP.
