...
metadata:
  short-description: "Use when the user asks to generate, remix, poll, list, download, or delete Sora videos via OpenAI\u2019s video API..."
---
...
- Use the OpenAI uv run python SDK (`openai` package); do not use raw HTTP.
