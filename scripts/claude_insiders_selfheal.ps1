...
# 1) RETIRED: Claude Code is now a compiled Bun binary (~/.local/bin/claude.exe).
#    The old npm cli.js patch is obsolete. VS Code Insiders detection is handled
#    natively by the extension since v2.1.x.
...
# 4) RETIRED: github@claude-plugins-official is DISABLED.
#    GitHub MCP is provided by manual .mcp.json entry (single source, no duplicates).
