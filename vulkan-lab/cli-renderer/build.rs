...
fn main() {
    ...
    for shader in ["euler_score.comp.glsl", "ascii_downsample.comp.glsl", "dirty_diff.comp.glsl", "ascii_dungeon.comp.glsl", "iso_render.comp.glsl", "archipelago_field.comp.glsl"] {
