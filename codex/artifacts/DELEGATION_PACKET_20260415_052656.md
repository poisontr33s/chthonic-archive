...
generated: 2026-04-15T05:26:56.009505+00:00
preset: gemma4-local-delegation
---

# Delegation Packet

- Mission: Improve Codex's ability to delegate an otherwise impossible local-model selection and operationalization task by supplying the missing context, runtime evidence, fallback tree, ANKH bridge logic, and refusal-transmutation loop up front.
...
```text
You are being used as a leverage engine, not as a generic assistant.

Mission
Improve Codex's ability to delegate an otherwise impossible local-model selection and operationalization task by supplying the missing context, runtime evidence, fallback tree, ANKH bridge logic, and refusal-transmutation loop up front.
