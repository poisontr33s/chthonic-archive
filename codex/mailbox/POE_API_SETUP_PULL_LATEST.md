...
- Generated: `2026-02-25T19:18:07Z`
- Account: `1`
- Current point balance: `3000`
- Balance error: `None`
- OpenAI max tokens: `1`
- Registry limit: `20`
- SDK probe limit: `2`
...
## Entitlement Verdict
- `api_access_blocked_by_subscription_or_points`
...
## Registry Summary
- total_models: `20`
- counts_by_best_status: `{'subscription_required': 20}`
- cheapest_callable: `[]`
...
## Rerun Commands
- `uv run scripts/poe_transport_audit.py --registry --registry-account 1 --registry-limit 20 --registry-transports openai,sdk --sdk-probe-limit 2 --openai-max-tokens 1 --prompt 'Return exactly: OK' --json`
