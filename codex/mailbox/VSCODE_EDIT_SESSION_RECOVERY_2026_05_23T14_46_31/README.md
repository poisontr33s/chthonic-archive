...
- Skipped edit-session source URI: `vscode-remote://tunnel%2Blaptop-draqgn8a/c%3A/Users/eldno/chthonic-archive`.
- Source cache copied from `%APPDATA%\Code - Insiders\Cache\Cache_Data` into `raw-cache/`.

## Decoded Files

- `../../../../c:/Users/eldno/chthonic-archive/.github/copilot-instructions.md` -> `decoded/.github/copilot-instructions.md` (314070 bytes)
- `../../../../c:/Users/eldno/chthonic-archive/.github/STRUCTURAL_INTEGRITY_ANALYSIS.md` -> `decoded/.github/STRUCTURAL_INTEGRITY_ANALYSIS.md` (9123 bytes)
- `../../../../c:/Users/eldno/chthonic-archive/.github/macro-prompt-world/DECORATOR-ASC-GENESIS.md` -> `decoded/.github/macro-prompt-world/DECORATOR-ASC-GENESIS.md` (26648 bytes)
- `../../../../c:/Users/eldno/chthonic-archive/.vscode/settings.json` -> `decoded/.vscode/settings.json` (8711 bytes)
- `../../../../c:/Users/eldno/chthonic-archive/mcp/tools/preflightExecutionContext.test.json` -> `decoded/mcp/tools/preflightExecutionContext.test.json` (2018 bytes)
