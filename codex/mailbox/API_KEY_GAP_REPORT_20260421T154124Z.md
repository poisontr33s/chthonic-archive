...
- Generated (UTC): 2026-04-21T15:41:24.6564391Z
...
- Registry path: `C:\Users\eldno\chthonic-archive\docs\standards\API_PROVIDER_REGISTRY.json`
- Env template: `C:\Users\eldno\chthonic-archive\codex\mailbox\API_KEY_ENV_TEMPLATE_20260421T154124Z.env`

## Key Matrix

| Key | Provider | Required | Available | Auth Mode | OAuth Alt | IaC | Source | In Pool | In Process | In User Env | Acquire URL |
|---|---|---:|---:|---|---:|---|---|---:|---:|---:|---|
| GITHUB_TOKEN | GitHub | True | True | api_key | False | high | pool | True | True | True | https://github.com/settings/tokens |
| POE_API_KEY | Poe | True | True | api_key | False | medium | pool | True | True | True | https://poe.com/api_key |
| POE_API_KEY_1 | Poe | True | True | api_key | False | medium | pool | True | True | True | https://poe.com/api_key |
| POE_API_KEY_2 | Poe | True | True | api_key | False | medium | pool | True | True | True | https://poe.com/api_key |
